    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <meta charset="UTF-8"/>
                {{ $style := resources.Get "/scss/style.scss" | resources.ExecuteAsTemplate "/scss/style.scss" . |
                resources.ToCSS (dict "targetPath" "css/styles.css" "outputStyle" "compressed" "enableSourceMap" "true")
            ...
            <body>
                <header>
                    ...
                    <div class="aboutfeeds">
                        <p>This is a web feed, also known as an RSS feed. <strong>Subscribe</strong> by copying the URL
