...
I implemented a first version and...it made things worse. The 30 seconds sometimes became 31 seconds 🤦 And then I realised I had forgotten to include the directive that would make the job use the [Burst Compiler](https://docs.unity3d.com/Packages/com.unity.burst@0.2/manual/index.html) 🤦🤦. And so we're down to 4 seconds! Now we're talking.
